...
function serveStatic(request, response) {
  ...
  if (!batchRegistrationEnabled && ['/', '/batch-register', '/batch-register/', '/batch-register/index.html', '/batch-register/claim.html', '/batch-register/vip.html', '/batch-register/trap.html'].includes(pathname)) {
