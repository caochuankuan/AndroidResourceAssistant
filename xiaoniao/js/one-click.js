...
async function performBirdBait() {
    ...
    try {
        ...
        const finishResponse = await fetch('http://49.232.48.114/api/fowling/all/finish', {
            method: 'POST',
            headers: {
        ...
        if (birdIds.length > 0) {
            ...
            const sellResponse = await fetch(`http://49.232.48.114/api/storage/bird/sell?id=${birdIds.join(',')}&confirm=true`, {
                method: 'POST',
                headers: {
                    'authorization': user.sso,
                    'Content-Type': 'application/json'
        ...
        const placeBaitResponse = await fetch('http://49.232.48.114/api/fowling/place/all?bid=1', {
            method: 'POST',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
        ...
        if (placeBaitResponse.ok) {
            try {
                ...
                if (placeBaitData.code === 200) {
                    ...
                    const buyBaitResponse = await fetch('http://49.232.48.114/api/shop/buy/goods?func=BAIT&id=1&num=5', {
                        method: 'POST',
                        headers: {
                            'authorization': user.sso,
                            'Content-Type': 'application/json'
                    ...
                    if (buyBaitResponse.ok) {
                        try {
                            ...
                            if (buyBaitData.code === 200) {
                                ...
                                const retryPlaceBaitResponse = await fetch('http://49.232.48.114/api/fowling/place/all?bid=1', {
                                    method: 'POST',
                                    headers: {
                                        'authorization': user.sso,
                                        'Content-Type': 'application/json'
...
async function performFamilyFight() {
    ...
    try {
        ...
        const listResponse = await fetch('http://49.232.48.114/api/task/family/list?page=0', {
            method: 'GET',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
        ...
        for (let i = 1; i <= 5; i++) {
            try {
                ...
                const fightResponse = await fetch(`http://49.232.48.114/api/task/family?id=${familyId}`, {
                    method: 'POST',
                    headers: {
                        'authorization': user.sso,
                        'Content-Type': 'application/json'
                ...
                if (fightResponse.ok) {
                    try {
                        ...
                        if (fightData.code === 200) {
                            ...
                            if (fightData.data) {
                                addOutput(`切磋结果: ${JSON.stringify(fightData.data)}`, 'info');
                            }
                            successCount++;
                        } else {
...
async function claimAllRewards() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/activity/claim/all', {
            method: 'POST',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
...
async function guildSignIn() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/guild/salary?get=true', {
            method: 'POST',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
...
async function guildDonateYuanbao() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/guild/donateOk?ft=3&fp=100', {
            method: 'POST',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
    ...
    try {
        ...
        for (let i = 1; i <= 2; i++) {
            try {
                ...
                const response = await fetch('http://49.232.48.114/api/guild/donateOk?ft=1&fp=20000', {
                    method: 'POST',
                    headers: {
                        'authorization': user.sso,
                        'Content-Type': 'application/json'
    ...
    try {
        ...
        for (let i = 1; i <= 15; i++) {
            try {
                ...
                const surroundResponse = await fetch('http://49.232.48.114/api/fight/surround', {
                    method: 'GET',
                    headers: {
                        'authorization': user.sso,
                        'Content-Type': 'application/json'
                ...
                // 进行战斗
                const fightResponse = await fetch(`http://49.232.48.114/api/fight/fight?uid=${targetUid}`, {
                    method: 'POST',
                    headers: {
                        'authorization': user.sso,
                        'Content-Type': 'application/json'
...
async function withdrawMoney() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/bank/out?num=100000', {
            method: 'PUT',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
...
async function checkTaskProgress() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/activity/points?includeDetails=true', {
            method: 'GET',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
...
async function performSignIn() {
    ...
    try {
        ...
        const response = await fetch('http://49.232.48.114/api/task/dailyfeed?feed=true', {
            method: 'GET',
            headers: {
                'authorization': user.sso,
                'Content-Type': 'application/json'
